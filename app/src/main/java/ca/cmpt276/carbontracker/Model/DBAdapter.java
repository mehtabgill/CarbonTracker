...
public class DBAdapter {
    ...
    public static final int COL_TRANSPORTATION = 2;
    public static final int COL_ROUTE = 3;
    public static final int COL_DESCRIPTION = 4;


    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_NAME, KEY_TRANSPORTATION, KEY_ROUTE, KEY_DESCRIPTION};
    ...
    public long insertRow(String name, String transportation, String route, String description) {
		/*
		 * CHANGE 3:
		 */
        ...
        initialValues.put(KEY_TRANSPORTATION, transportation);
    ...
    public boolean updateRow(long rowId, String name, String transportation, String route, String description) {
        String where = KEY_ROWID + "=" + rowId;
        ...
        newValues.put(KEY_TRANSPORTATION, transportation);
